...
|  05  | 09/25 - 09/29 | [recursion notes](lec-notes/lec09-recursion.pdf) <br> [Mon: bunny pop act](misc-files/recursion.md) <br> [Mon: bunny - example code](misc-files/lec-demos/recursion/bunny-population.py) <br> [Wed: summing elements - example code](misc-files/lec-demos/recursion/summing-elements.py) | [lab4](https://us.prairielearn.com/pl/course_instance/141391/assessment/2368559) |  |
